#vSphere and Sequencer VM Configuration
	$Sequencer = 'Sequencer Name' #Computer name of Sequencer VM
    $ODUser = "$Sequencer\UserName" #Local user admin account on Sequencer (Off Domain User)
    ...
    $VIServerName = 'vSphere Server Name' #vSphere VI Server Name
