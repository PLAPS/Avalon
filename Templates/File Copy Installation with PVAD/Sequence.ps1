##File Copy Installation with PVAD
...
#Create Sequence
New-AppvSequencerPackage -Name "$($AppName)_v$Version" -Path $LocalDest -PrimaryVirtualApplicationDirectory $PVAD -Installer "$ProcessFolder\Process.ps1"
